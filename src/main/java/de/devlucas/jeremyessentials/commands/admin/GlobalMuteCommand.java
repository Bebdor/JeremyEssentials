...
@main(command = "globalmute", description = "A command that forces the Player to be quiet.", permission = "jeremyessentials.globalmute", isConsoleCommand = false, isAdminCommand = true)
